...
import com.stcum.transporteservice.service.TransporteService;
 ...
 * @author khdx
 */
@WebServlet(name = "TransporteRegisterServlet", urlPatterns = {"/TransporteRegisterServlet"})
public class TransporteRegisterServlet extends HttpServlet {
    private TransporteService transporteService;
    
    public TransporteRegisterServlet(){
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TransporteRegisterServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TransporteRegisterServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
