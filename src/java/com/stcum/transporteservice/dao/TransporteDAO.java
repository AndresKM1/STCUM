...
public class TransporteDAO {
    ...
    public void insertarTransporte(String tipovehiculo, int capacidad, String condicionesgenerales, double precio, int idUsuario) {
        String sql = "INSERT INTO transportes (idUsuario, tipovehiculo, capacidad, condicionesgenerales, precio) VALUES (?, ?, ?, ?, ?)";
